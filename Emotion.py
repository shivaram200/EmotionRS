...
main = tkinter.Tk()
main.title("MUSIC RECOMMENDATION SYSTEM")
...
font = ('times', 20, 'bold')
title = Label(main, text='MUSIC RECOMMENDATION SYSTEM')
...
stopsong = Button(main, text="Stop Song", command=stopSong)
stopsong.place(x=200, y=250)
stopsong.config(font=font1)
